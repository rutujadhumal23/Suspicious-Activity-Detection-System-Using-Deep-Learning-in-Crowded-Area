...
root = tk.Tk()
root.configure(background="#2471a3")
...
Login_frame = tk.LabelFrame(root, text="🅻🅾🅶🅸🅽 🅷🅴🆁🅴", width=750, height=400, bd=2, font=('times',30, ' bold '),bg="black",fg="White")
Login_frame.grid(row=0, column=0, sticky='nw')
Login_frame.place(x=950, y=400)

#Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=500,y=350)
...
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="#2ecc71",fg="black")
btn_log.grid(row=3,column=1,pady=10)


btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="#a6acaf",fg="black")
