...
img = Image.open(basepath + "b5.jpg")
...
heading = tk.Label(root,text="Anomaly Detection",width=30,font=("Times New Roman",45,'bold'),bg="black",fg="white")
...
###@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
button4 = tk.Button(root,command = SVM_Train, text="Anomaly Detection using SVM", width=25,font=("Times new roman", 25, "bold"),bg="black",fg="white")
button4.place(x=100,y=250)           

button5 = tk.Button(root,command = Video_Verify, text="Anomaly Detection using CNN", width=25,font=("Times new roman", 25, "bold"),bg="black",fg="white")
